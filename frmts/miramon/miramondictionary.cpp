...
MMRDictionary::MMRDictionary(const char *pszString)
...
void MMRDictionary::AddType(MMRType *poType)
...
MMRType *MMRDictionary::FindType(const char *pszName)
...
int MMRDictionary::GetItemSize(char chType)
...
/*                                Dump()                                */
/************************************************************************/
// ·$·TODO Que es aixo del diccionari?
void MMRDictionary::Dump(FILE *fp)
